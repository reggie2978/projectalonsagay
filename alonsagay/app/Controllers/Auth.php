...
class Auth extends BaseController
{
    ...
    protected $data = []; // ✅ FIX: declare $data to prevent dynamic property warning
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if ($password != $cpassword) {
                ...
                if ($update) {
                    ...
                    $session->setFlashdata('error', "Your Account failed to update.");
                }
            }
        }

        // ✅ FIX: use $this->data instead of undeclared dynamic property
